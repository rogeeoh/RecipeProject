...
<div class="showoffDiv col-md-9">
	<div class="row">
		<!-- 게시글 등록하기 -->
		<a class="btn btn-block" href="/recipe_project/community_showoff?cmd=write" style="margin-bottom: 2%"><h1>게시글 등록하기</h1></a>
		<!-- 게시글 리스트 -->
			...
			<div class="col-md-10" style="margin-bottom: 2%">
				<div class="row">
					<div class="col-md-12" id="titleDiv">
						<h2><a href="/recipe_project/community_showoff?no=${showoff.showoff_no}">${showoff.title}</a></h2>
					</div>
					...
					<div class="col-md-12" id="imgDiv">
						<a href="/recipe_project/community_showoff?no=${showoff.showoff_no}"><img src="${showoff.pic_url}"></a>
					</div>
				</div>
			</div>
		</c:forEach>
