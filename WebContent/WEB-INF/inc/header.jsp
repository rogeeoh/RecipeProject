...
<link rel="stylesheet" type="text/css" href="/recipe_project/css/header.css">
...
<script>
	...
	$( document ).ready(function() {
	    $("#searchBtn").on("click", function(){
	    		...
	    		var url = '/recipe_project/search?query=' + query;
	    		location.href = url;
	    });
	});
	function openNav() {
...
<div id="flipkart-navbar">
	<div class="container">
		<div class="row row1">
			<ul class="largenav pull-right">
				<li class="upper-links"><a class="links"
					href="http://clashhacks.in/">Link 1</a></li>
				<li class="upper-links"><a class="links"
		...
		<div class="row row2">
			<div class="col-sm-2">
				<h2 style="margin: 0px;">
					<span class="smallnav menu" onclick="openNav()">☰ 레시피
					</span>
				</h2>
				<h1 style="margin: 0px;">
			...
			<div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
				<div class="row">
					<input class="flipkart-navbar-input col-xs-11" type=""
						placeholder="Search for Products, Brands and more" id="searchText">
					<button class="flipkart-navbar-button col-xs-1" id="searchBtn">
			...
			<div class="cart largenav col-sm-2">
				<a class="cart-button"> <svg class="cart-svg " width="16 "
                        ...
                        <path
							...
							fill="#fff "></path>
                    </svg> Link <span class="item-number ">0</span>
				</a>
			</div>
		</div>
	</div>
